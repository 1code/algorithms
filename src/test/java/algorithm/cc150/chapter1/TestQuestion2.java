...
public class TestQuestion2 extends TestBase {
  ...
  public void testPosCase() {
    ...
    assertArrayEquals("abcde".toCharArray(),
        question.reverse("edcba".toCharArray()));
    assertArrayEquals(" ".toCharArray(), question.reverse(" ".toCharArray()));
    assertArrayEquals("1234567890!@#$%^&*()".toCharArray(),
        question.reverse(")(*&^%$#@!0987654321".toCharArray()));
  }

  @Override
  public void testNegCase() {
    assertFalse(Arrays.equals("abc".toCharArray(),
        question.reverse("abc".toCharArray())));
  }
